...
| Tests | `flutter test --no-pub` | PASS | All 29 current tests pass. They cover schema 3/4 to 5 migration, sync registration and status projection, repeat metadata/validation/metrics, submission completion and upload transitions, assignment ownership, managed-team/activity projection, and live sync-badge state. |
...
- The 29 tests are targeted characterization checks, not broad product coverage.
