...
| Tests | `flutter test --no-pub` | PASS | All 26 current tests pass. They cover schema 3/4 to 5 migration, sync registration, repeat metadata/validation/metrics, submission completion and upload transitions, assignment ownership, and managed-team scoping. |
...
- The 26 tests are targeted characterization checks, not broad product coverage.
