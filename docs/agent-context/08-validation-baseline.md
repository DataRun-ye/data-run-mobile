...
| Static analysis | `flutter analyze --no-pub` | NO ERRORS; LINT DEBT | Reports 118 findings: 8 strict raw-type warnings and 110 style/info findings. Most were previously hidden under the nested SDK analyzer boundary and became visible after consolidation. Do not increase this count; clean it in bounded ownership slices rather than mixing it into mechanical moves. |
