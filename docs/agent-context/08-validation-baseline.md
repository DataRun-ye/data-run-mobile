...
| Tests | `flutter test --no-pub` | PASS | All 27 current tests pass. They cover schema 3/4 to 5 migration, sync registration, repeat metadata/validation/metrics, submission completion and upload transitions, assignment ownership, managed-team scoping, and live sync-badge state. |
...
- The 27 tests are targeted characterization checks, not broad product coverage.
