...
//
// part 'current_user_state_notifier.provider.g.dart';
//
// @riverpod
// class CurrentUserState extends _$CurrentUserState {
//   @override
//   Future<CurrentUserEntity?> build() async {
//     final cachedUser = await _userSessionRepository.getActiveSession();
//     if (cachedUser != null) {
//       final dbManager = await appLocator.getAsync<DbManager>();
//       final userData = await dbManager.loadAuthUserData();
//
//       return AuthState.authenticated(AuthenticatedUserDetail.fromMap(userData!.toJson()));
//     }
//     return const AuthState.unauthenticated();
//   }
//
//   SessionRepository get _userSessionRepository =>
//       appLocator<SessionRepository>();
//
//   AuthenticationService get _authenticationService =>
//       appLocator<AuthenticationService>();
//
...
//   Future<CachedUserDetail> _updateCached(User user, String baseUrl) async {
//     final cachedUser =
//         CachedUserDetail.fromMap({...user.toJson(), 'baseUrl': baseUrl});
//     await _userSessionRepository.setCurrentSession(cachedUser);
//     final dbManager = await appLocator.getAsync<DbManager>();
