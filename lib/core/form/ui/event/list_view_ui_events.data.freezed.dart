...
/// Adds pattern-matching-related methods to [ListViewUiEvents].
extension ListViewUiEventsPatterns on ListViewUiEvents {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    final _that = this;
    switch (_that) {
      case OpenYearMonthDayAgeCalendar()
          when openYearMonthDayAgeCalendar != null:
        return openYearMonthDayAgeCalendar(_that);
      case OpenCustomCalendar() when openCustomCalendar != null:
        return openCustomCalendar(_that);
      case OpenTimePicker() when openTimePicker != null:
        return openTimePicker(_that);
      case ShowDescriptionLabelDialog() when showDescriptionLabelDialog != null:
        return showDescriptionLabelDialog(_that);
      case RequestCurrentLocation() when requestCurrentLocation != null:
        return requestCurrentLocation(_that);
      case RequestLocationByMap() when requestLocationByMap != null:
        return requestLocationByMap(_that);
      case ScanQRCode() when scanQRCode != null:
        return scanQRCode(_that);
      case DisplayQRCode() when displayQRCode != null:
        return displayQRCode(_that);
      case OpenOrgUnitDialog() when openOrgUnitDialog != null:
        return openOrgUnitDialog(_that);
      case AddImage() when addImage != null:
        return addImage(_that);
      case ShowImage() when showImage != null:
        return showImage(_that);
      case CopyToClipboard() when copyToClipboard != null:
        return copyToClipboard(_that);
      case OpenOptionSetDialog() when openOptionSetDialog != null:
        return openOptionSetDialog(_that);
      case _:
        return orElse();
    }
  }
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case OpenYearMonthDayAgeCalendar():
        return openYearMonthDayAgeCalendar(_that);
      case OpenCustomCalendar():
        return openCustomCalendar(_that);
      case OpenTimePicker():
        return openTimePicker(_that);
      case ShowDescriptionLabelDialog():
        return showDescriptionLabelDialog(_that);
      case RequestCurrentLocation():
        return requestCurrentLocation(_that);
      case RequestLocationByMap():
        return requestLocationByMap(_that);
      case ScanQRCode():
        return scanQRCode(_that);
      case DisplayQRCode():
        return displayQRCode(_that);
      case OpenOrgUnitDialog():
        return openOrgUnitDialog(_that);
      case AddImage():
        return addImage(_that);
      case ShowImage():
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      case OpenYearMonthDayAgeCalendar()
          when openYearMonthDayAgeCalendar != null:
        return openYearMonthDayAgeCalendar(
            _that.uid, _that.year, _that.month, _that.day);
      case OpenCustomCalendar() when openCustomCalendar != null:
        return openCustomCalendar(_that.uid, _that.label, _that.date,
            _that.allowFutureDates, _that.isDateTime);
      case OpenTimePicker() when openTimePicker != null:
        return openTimePicker(
            _that.uid, _that.label, _that.date, _that.isDateTime);
      case ShowDescriptionLabelDialog() when showDescriptionLabelDialog != null:
        return showDescriptionLabelDialog(_that.title, _that.message);
      case RequestCurrentLocation() when requestCurrentLocation != null:
        return requestCurrentLocation(_that.uid);
      case RequestLocationByMap() when requestLocationByMap != null:
        return requestLocationByMap(_that.uid, _that.value);
      case ScanQRCode() when scanQRCode != null:
        return scanQRCode(_that.uid, _that.optionSet, _that.renderingType);
      case DisplayQRCode() when displayQRCode != null:
        return displayQRCode(_that.uid, _that.optionSet, _that.value,
            _that.renderingType, _that.editable);
      case OpenOrgUnitDialog() when openOrgUnitDialog != null:
        return openOrgUnitDialog(_that.uid, _that.label, _that.value);
      case AddImage() when addImage != null:
        return addImage(_that.uid);
      case ShowImage() when showImage != null:
        return showImage(_that.label, _that.value);
      case CopyToClipboard() when copyToClipboard != null:
        return copyToClipboard(_that.value);
      case OpenOptionSetDialog() when openOptionSetDialog != null:
        return openOptionSetDialog(_that.field);
      case _:
        return orElse();
    }
  }
...
class OpenYearMonthDayAgeCalendar extends ListViewUiEvents
...
class OpenCustomCalendar extends ListViewUiEvents with DiagnosticableTreeMixin {
...
class OpenTimePicker extends ListViewUiEvents with DiagnosticableTreeMixin {
...
class ShowDescriptionLabelDialog extends ListViewUiEvents
    with DiagnosticableTreeMixin {
  const ShowDescriptionLabelDialog(this.title, this.message) : super._();
...
class RequestCurrentLocation extends ListViewUiEvents
    with DiagnosticableTreeMixin {
  const RequestCurrentLocation({required this.uid}) : super._();
...
class RequestLocationByMap extends ListViewUiEvents
    with DiagnosticableTreeMixin {
  const RequestLocationByMap({required this.uid, this.value}) : super._();
...
class ScanQRCode extends ListViewUiEvents with DiagnosticableTreeMixin {
...
class DisplayQRCode extends ListViewUiEvents with DiagnosticableTreeMixin {
  const DisplayQRCode(
      {required this.uid,
      this.optionSet,
      required this.value,
...
class OpenOrgUnitDialog extends ListViewUiEvents with DiagnosticableTreeMixin {
...
class AddImage extends ListViewUiEvents with DiagnosticableTreeMixin {
  const AddImage(this.uid) : super._();
...
class ShowImage extends ListViewUiEvents with DiagnosticableTreeMixin {
  const ShowImage({required this.label, required this.value}) : super._();
...
class CopyToClipboard extends ListViewUiEvents with DiagnosticableTreeMixin {
  const CopyToClipboard({this.value}) : super._();
...
class OpenOptionSetDialog extends ListViewUiEvents
    with DiagnosticableTreeMixin {
  const OpenOptionSetDialog({required this.field}) : super._();
