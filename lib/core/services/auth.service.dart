...
// import 'package:datarunmobile/core/exceptions/account_exception.dart';
...
//             message: 'No Active Session Data, user should not be logged in');
//       }
//
//       DatabaseFactory? databaseFactory;
//       if (Platform.isWindows) {
...
//       if (e.errorCode == DRunErrorCode.authInvalidCredentials) {
//         await logout();
//         rethrow;
//       }
//
...
//         sharedPreferenceInstance: appLocator<SharedPreferences>());
