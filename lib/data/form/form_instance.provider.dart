...
//             .future);
//     return FormFlatTemplate.fromTemplate(templateId: submission.formVersion);
//   }
//
//   final FormVersion formVersion = await ref.watch(
//       submissionVersionFormTemplateProvider(formId: formMetadata.formId)
//           .future);
//   return FormFlatTemplate.fromTemplate(templateId: formMetadata.formId);
// }
//
// @riverpod
...
//       template: SectionTemplate(path: '', id: ''),
//       elements: elements,
//       form: form);
//   // ..resolveDependencies()
