...
/// See also [formSubmissionData].
class FormSubmissionDataFamily
    extends Family<AsyncValue<IMap<String, dynamic>>> {
  /// See also [formSubmissionData].
...
class FormSubmissionDataProvider
  ...
  @override
  Override overrideWith(
    FutureOr<IMap<String, dynamic>> Function(FormSubmissionDataRef provider)
        create,
  ) {
    return ProviderOverride(
      origin: this,
...
abstract class _$FormSubmissions
  ...
  FutureOr<IList<DataSubmission>> build(
    String form,
  );
}
...
/// See also [FormSubmissions].
class FormSubmissionsFamily extends Family<AsyncValue<IList<DataSubmission>>> {
  /// See also [FormSubmissions].
...
class FormSubmissionsProvider extends AutoDisposeAsyncNotifierProviderImpl<
    FormSubmissions, IList<DataSubmission>> {
  /// See also [FormSubmissions].
  ...
  @override
  FutureOr<IList<DataSubmission>> runNotifierBuild(
  ...
  AutoDisposeAsyncNotifierProviderElement<FormSubmissions,
      IList<DataSubmission>> createElement() {
...
mixin FormSubmissionsRef
    on AutoDisposeAsyncNotifierProviderRef<IList<DataSubmission>> {
...
class _FormSubmissionsProviderElement
    extends AutoDisposeAsyncNotifierProviderElement<FormSubmissions,
        IList<DataSubmission>> with FormSubmissionsRef {
