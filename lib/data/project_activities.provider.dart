...
@riverpod
Future<List<Team>> userAssignedTeams(Ref ref, {String? activity}) async {
...
FutureOr<List<Activity>> userAssignedActivities(Ref ref,
  ...
  final teams = await ref.watch(userAssignedTeamsProvider().future);
  final List<String> userActivitiesUids = teams.map((t) => t.activity).toList();
...
@riverpod
Future<List<Activity>> projectActiveActivities(Ref ref, String project) async {
...
@riverpod
Future<Team?> activityTeam(Ref ref, {required String activity}) async {
