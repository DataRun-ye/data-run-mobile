...
// import 'package:d_sdk/database/app_database.dart';
// import 'package:d_sdk/modules/datarun/form/shared/attribute_type.dart';
...
//     required Map<String, List<DataOption>> optionLists,
...
//     final FormTemplateVersion? template =
//         await D2Remote.formModule.formTemplateV.byId(templateId).getOne();
//     Map<String, List<DataOption>> optionLists = await getOptionSets(template);
//     final fields =
...
//   final Map<String, List<DataOption>> optionLists;
//
...
//     Iterable<DataOption> options = const [],
...
//
//   List<DataOption> get options => List.unmodifiable(_options);
//
