...
//
// class DetailsSubmissionsTableView extends HookConsumerWidget {
//   const DetailsSubmissionsTableView(
//       {super.key,
...
//         .watch(formSubmissionsProvider(this.template.template.id))
//         .requireValue
...
//                   label:
//                       Text('${S.of(context).syncSubmissions(toSync.length)}'))
//             ],
//           ),
//         SizedBox(
//           height: 8,
...
//                               } else {
//                                 selectedSubmissions.value = selectedSubmissions
//                                     .value
//                                     .remove(submission);
//                               }
//                             },
...
//                                     : null,
//                                 child:
//                                     StatusIcon(syncState: submission.syncState),
//                               )),
//                               DataCell(IconButton(
//                                 onPressed: !deleted
//                                     ? () async {
