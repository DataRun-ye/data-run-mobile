...
import 'package:datarunmobile/features/assignment_type/presentation/assignment_type_list_viewmodel.dart';
import 'package:datarunmobile/generated/l10n.dart';
import 'package:flutter/material.dart';
import 'package:stacked/stacked.dart';

class AssignmentTypeListView extends StatelessWidget {
  const AssignmentTypeListView(
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<AssignmentTypeListViewModel>.reactive(
      viewModelBuilder: () => AssignmentTypeListViewModel(),
