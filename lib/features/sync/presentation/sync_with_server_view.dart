...
class SyncProgressView extends StackedView<SyncProgressViewModel> {
  ...
  Widget _buildResourceList(
    ...
    return Column(
      ...
      children: [
        Text(S.of(context).currentOperations),
  ...
  Widget _buildResourceItem(ResourceProgress progress,
    ...
    return ListTile(
      ...
      title: Text(Intl.message(progress.resourceName)),
  ...
  Widget _buildResourceSubtitle(
    ...
    return switch (progress.state) {
      ResourceStarting() => Text(S.of(context).startingSync),
      ResourceSucceeded s => Row(
          children: [
            ...
            Text(
                '${Intl.message(progress.resourceName)} ${S.of(context).downloaded}'),
          ],
        ),
