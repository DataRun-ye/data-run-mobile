...
import 'package:datarunmobile/home/form_submissions/presentation/submission_edit_attributes_view.dart';
import 'package:datarunmobile/home/form_submissions/presentation/submission_edit_entry_sliver_view.dart';
import 'package:flutter/material.dart';
import 'package:flutter_hooks/flutter_hooks.dart';
import 'package:hooks_riverpod/hooks_riverpod.dart';
import 'package:reactive_forms/reactive_forms.dart';

class SubmissionEditScreen extends StatefulHookConsumerWidget {
  const SubmissionEditScreen({
    super.key,
  ...
  @override
  SubmissionCreateScreenState createState() => SubmissionCreateScreenState();
}

class SubmissionCreateScreenState extends ConsumerState<SubmissionEditScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return AsyncValueWidget(
        ...
        valueBuilder: (canEdit) {
          final formFlatTemplateAsync = ref
              .watch(submissionFormFlatTemplateProvider(submissionId: widget.submissionId));
...
class _SubmissionTabScreenState extends ConsumerState<FormTabScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final _buildBody = <Widget>[
      const SubmissionEditAttributesView(),
      // FormInstanceEntryView(scrollController: scrollController),
      SubmissionEditEntrySliver(scrollController: scrollController),
    ];
