...
class CreateSubmissionSheetModel extends BaseViewModel {
  ...
  final _navigationSheetService = locator<NavigationService>();
  final _assignmentService = locator<AssignmentListService>();
  final _formService = locator<FormListService>();
  final _submissionService = locator<FormSubmissionListService>();
